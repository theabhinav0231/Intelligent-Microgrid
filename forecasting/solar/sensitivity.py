...
from forecasting.solar.forecaster import SolarForecaster, FEATURE_COLS, TARGET_COL

# ── Config ──────────────────────────────────────────────────────────────
DATA_PATH   = os.path.join("forecasting", "data", "solar", "solar_forecaster_training_data.csv")
